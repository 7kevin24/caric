...
void update_gimbal(Eigen::Vector3d direction_global, bool print)
    {   
        // curent relative direction is target position - now_global_position 
        if (print)
        {
            cout << "direction_global:" << direction_global.transpose() << endl;
            // cout<<"matrix:"<<endl;
        ...
        // }
            ...
            Eigen::Vector3d relative_direction = search_direction.front() - now_position_global;
            if((direction_global - relative_direction).norm()<0.3){
                search_direction.pop_front();
            }
        }
    }